function compareSkewnessDifferencesFor8_12Hz(skewnessResults)
    ...
    for i = 1:numel(keys)
        ...
        diff_EO_EC_8_12 = skewness_8_12.EO - skewness_8_12.EC;
        diff_EO_DEC_8_12 = skewness_8_12.EO - skewness_8_12.DEC;
        diff_EO_NDEC_8_12 = skewness_8_12.EO - skewness_8_12.NDEC;
    ...
    title('Comparison of Skewness Differences for Amblyopia and Control (8-12 Hz)');
    grid on;
    ylim(common_ylim);
end
