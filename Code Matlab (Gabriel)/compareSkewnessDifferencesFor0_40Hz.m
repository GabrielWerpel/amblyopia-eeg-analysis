function compareSkewnessDifferencesFor0_40Hz(skewnessResults)
    ...
    for i = 1:numel(keys)
        ...
        diff_EO_EC_0_40 = skewness_0_40.EO - skewness_0_40.EC;
        diff_EO_DEC_0_40 = skewness_0_40.EO - skewness_0_40.DEC;
        diff_EO_NDEC_0_40 = skewness_0_40.EO - skewness_0_40.NDEC;
    ...
    % Perform statistical tests between conditions within each group for 0-40 Hz
    [h_EO_EC_vs_EO_DEC_A, p_EO_EC_vs_EO_DEC_A] = ttest(diff_EO_EC_0_40_A, diff_EO_DEC_0_40_A);
    [h_EO_EC_vs_EO_NDEC_A, p_EO_EC_vs_EO_NDEC_A] = ttest(diff_EO_EC_0_40_A, diff_EO_NDEC_0_40_A);
    [h_EO_DEC_vs_EO_NDEC_A, p_EO_DEC_vs_EO_NDEC_A] = ttest(diff_EO_DEC_0_40_A, diff_EO_NDEC_0_40_A);

    [h_EO_EC_vs_EO_DEC_C, p_EO_EC_vs_EO_DEC_C] = ttest(diff_EO_EC_0_40_C, diff_EO_DEC_0_40_C);
    [h_EO_EC_vs_EO_NDEC_C, p_EO_EC_vs_EO_NDEC_C] = ttest(diff_EO_EC_0_40_C, diff_EO_NDEC_0_40_C);
    [h_EO_DEC_vs_EO_NDEC_C, p_EO_DEC_vs_EO_NDEC_C] = ttest(diff_EO_DEC_0_40_C, diff_EO_NDEC_0_40_C);

    % Perform statistical tests between groups for each condition for 0-40 Hz
    [h_diff_EO_EC, p_diff_EO_EC] = ttest2(diff_EO_EC_0_40_A, diff_EO_EC_0_40_C);
    [h_diff_EO_DEC, p_diff_EO_DEC] = ttest2(diff_EO_DEC_0_40_A, diff_EO_DEC_0_40_C);
    [h_diff_EO_NDEC, p_diff_EO_NDEC] = ttest2(diff_EO_NDEC_0_40_A, diff_EO_NDEC_0_40_C);

    % Display the results of statistical tests between conditions within each group for 0-40 Hz
    ...
    % Display the results of statistical tests between groups for each condition for 0-40 Hz
    ...
    groupLabels_A = repmat({'Amblyopia'}, numel(diff_EO_EC_0_40_A), 1);
    groupLabels_C = repmat({'Control'}, numel(diff_EO_EC_0_40_C), 1);

    dataA = [repmat({'EO-EC'}, size(diff_EO_EC_0_40_A)); repmat({'EO-DEC'}, size(diff_EO_DEC_0_40_A)); repmat({'EO-NDEC'}, size(diff_EO_NDEC_0_40_A))];
    dataC = [repmat({'EO-EC'}, size(diff_EO_EC_0_40_C)); repmat({'EO-DEC'}, size(diff_EO_DEC_0_40_C)); repmat({'EO-NDEC'}, size(diff_EO_NDEC_0_40_C))];

    combinedData = table([dataA; dataC], ...
                         [diff_EO_EC_0_40_A; diff_EO_DEC_0_40_A; diff_EO_NDEC_0_40_A; diff_EO_EC_0_40_C; diff_EO_DEC_0_40_C; diff_EO_NDEC_0_40_C], ...
    ...
    all_differences = [diff_EO_EC_0_40_A; diff_EO_DEC_0_40_A; diff_EO_NDEC_0_40_A; ...
                       diff_EO_EC_0_40_C; diff_EO_DEC_0_40_C; diff_EO_NDEC_0_40_C];
    ...
    title('Comparison of Skewness Differences for Amblyopia and Control (0-40 Hz)');
    grid on;
    ylim(common_ylim);
end
